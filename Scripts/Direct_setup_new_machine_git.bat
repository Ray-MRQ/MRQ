...
cls
mkdir c:\temp
bitsadmin /transfer myDownloadJob /download /priority normal "https://github.com/Ray-MRQ/MRQ/raw/master/Scripts/Setup_new_machine.ps1" c:\temp\setup_new_machine.ps1
