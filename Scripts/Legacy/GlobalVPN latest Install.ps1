...
###########################UNINSTALL############################
Write-Output "Uninstalling 4.9.9 if it exists."
Start-Process msiexec -wait -argumentlist "/X {0E14625B-DF56-4657-8678-DFD1955BE97A} /qn /norestart"
Write-Outpute-Output "Uninstalling 4.10.2 if it exists."
Start-Process msiexec -wait -argumentlist "/X {7D7ED176-EA00-4B2B-B421-AA19A451F650} /qn /norestart"
############################INSTALL#############################
Write-Output "Starting GlobalVPN silent install"
Invoke-Webrequest $LatestGlobalVPN -outfile c:\temp\GVCInstall64.msi
